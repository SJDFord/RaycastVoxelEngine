...
class SimpleRenderSystemTyped {
 public:
  SimpleRenderSystemTyped(
      Device &device,
      const vk::raii::RenderPass &renderPass,
      const vk::raii::DescriptorSetLayout &globalSetLayout);
  ~SimpleRenderSystemTyped();

  SimpleRenderSystemTyped(const SimpleRenderSystemTyped &) = delete;
  SimpleRenderSystemTyped &operator=(const SimpleRenderSystemTyped &) = delete;
