...
namespace DescriptorSetUtils {
                               ...
                               uint32_t                                                                                                        bindingOffset )
    {
      ...
      vk::DescriptorImageInfo imageInfo( textureData.getSampler(), textureData.getImage()->getImageView(), vk::ImageLayout::eShaderReadOnlyOptimal );
                               ...
                               uint32_t                                                                                                        bindingOffset )
    {
      ...
      if ( !textureData.empty() )
      {
        ...
        {
          imageInfos.emplace_back( td.getSampler(), td.getImage()->getImageView(), vk::ImageLayout::eShaderReadOnlyOptimal );
        }
